...
def run(args, verbose=False):
    ...
    if (utils.checkattr(args, 'feedback') or train_gen) and args.experiment in ["CIFAR100", "ASL", "fruits360", "chars74k", "gtsrb"] and args.scenario=="class":
    ...
    if args.pdf:
        ...
        if gen_eval and args.experiment in ["CIFAR100", "ASL", "fruits360", "chars74k", "gtsrb"] and args.scenario=="class" and FileFound:
